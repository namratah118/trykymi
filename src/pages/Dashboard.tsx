    ...
    <AppLayout>
      ...
      <div className="max-w-7xl mx-auto space-y-6 sm:space-y-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
          {[
            { icon: CalendarDays, label: "Today's Plans", value: `${stats.completedPlans}/${stats.todayPlans}`, link: '/plan', delay: 100 },
            { icon: Target, label: 'Habits Done', value: `${stats.completedHabitsToday}/${stats.totalHabits}`, link: '/habits', delay: 200 },
            { icon: CheckSquare, label: 'Tasks Done', value: `${stats.completedTasks}/${stats.totalTasks}`, link: '/tasks', delay: 300 },
            { icon: Bell, label: 'Reminders', value: String(stats.upcomingReminders), link: '/reminders', delay: 400 },
          ].map((stat, i) => (
            <Link
              key={i}
              to={stat.link}
            ...
            >
              ...
              <p className="font-heading text-xl sm:text-2xl lg:text-3xl font-semibold text-center" style={{ letterSpacing: '-0.03em', color: '#F7F4D5' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
            <div className="rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 flex items-center gap-4 sm:gap-6 shadow-md hover:shadow-xl transition-all duration-300 w-full" style={GLASS}>
              ...
              <div>
                ...
                <p className="font-heading text-lg sm:text-xl lg:text-2xl font-semibold" style={{ letterSpacing: '-0.03em', color: '#F7F4D5' }}>
                  <AnimatedNumber value={`${Math.floor(timeLost / 60)}h ${timeLost % 60}m`} delay={500} />
                </p>
              </div>
            </div>
            <div className="rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 flex items-center gap-4 sm:gap-6 shadow-md hover:shadow-xl transition-all duration-300 w-full" style={GLASS}>
              ...
              <div>
                ...
                <p className="font-heading text-lg sm:text-xl lg:text-2xl font-semibold" style={{ letterSpacing: '-0.03em', color: '#F7F4D5' }}>
                  <AnimatedNumber value={`${Math.floor(timeWon / 60)}h ${timeWon % 60}m`} delay={600} />
                </p>
              </div>
            </div>
          </div>
