    ...
    <div className="min-h-screen flex" style={{ background: '#0A3323' }}>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 relative z-10">
        <div className="w-full max-w-sm animate-slide-up">
          ...
          >
            <h1 className="font-heading text-2xl font-semibold mb-6" style={{ letterSpacing: '-0.025em', color: '#F7F4D5' }}>Create account</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-body font-semibold mb-1.5" style={{ color: 'rgba(247,244,213,0.75)' }}>Your name</label>
                <input
                  type="text"
                  value={fullName}
                  onChange={e => setFullName(e.target.value)}
                  className="w-full px-4 py-3 rounded-xl font-body text-sm transition-all duration-200 focus:outline-none"
                  style={inputStyle}
                  placeholder="What should trykymi call you?"
                  required
                  autoFocus
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 pr-11 rounded-xl font-body text-sm transition-all duration-200 focus:outline-none"
                    style={inputStyle}
            ...
            <p className="text-center text-sm font-body mt-6" style={{ color: 'rgba(247,244,213,0.50)' }}>
              ...
              <Link to="/login" className="font-semibold transition-opacity hover:opacity-80" style={{ color: '#D3968C' }}>
                Sign in
              </Link>
            </p>
          </div>
